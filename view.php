...
<body>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-4">
        <?php include('modulos/filtro-inmueble.php'); ?>
      </div>
      <div class="col-md-8">
        <?php
          $consultarInm = "SELECT * FROM inmuebles WHERE estado='1'";
