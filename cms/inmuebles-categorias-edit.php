...
if($proceso == ""){
  $consultaCategoria = "SELECT * FROM inmuebles_categorias WHERE cod_categoria='$cod_categoria'";
...
if($proceso=="Actualizar"){ 
  ...
  $orden          = $_POST['orden'];
  $estado         = $_POST['estado'];
  $actualizarCategoria  = "UPDATE inmuebles_categorias SET cod_categoria='$cod_categoria', slug='$slug', categoria='$categoria', orden='$orden', estado='$estado' WHERE cod_categoria='$cod_categoria'";
  ...
  <head>
    ...
    <script>
      function Validar(){
        ...
        document.fcms.action = "inmuebles-categorias-edit.php";
        ...
        <div class="card">
          ...
          <form class="fcms" name="fcms" method="post" action="" data-provide="validation" data-disable="false">
            ...
            <footer class="card-footer">
              <a href="inmuebles-categorias.php" class="btn btn-secondary"><i class="fa fa-times"></i> Cancelar</a>
