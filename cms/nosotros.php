    ...
    <main>
      ...
      <div class="main-content">
        ...
        <div class="row">
          <div class="col-12 col-lg-12">
            <div class="card card-bordered">
              <h4 class="card-title"><strong>Contenido Footer</strong></h4>
              <div class="card-body">
                <div class="row">
                  <div class="col-12 col-lg-12">
                    <?php
                      ...
                      $filaCon = mysqli_fetch_array($resultadoCon);
                        ...
                        $xEstado      = $filaCon['estado'];
                    ?>
                    <img class="d-block b-1 border-light hover-shadow-2 p-1" width="300" src="assets/img/nosotros/<?php echo $xImagen; ?>" />
                    <p><?php 
              ...
              <div class="publisher bt-1 border-light">
                <a href="nosotros-edit.php?cod_contenido=<?php echo $xCodigo; ?>" class="btn btn-bold btn-primary"><i class="fa fa-refresh"></i> Editar Footer</a>
              </div>
            </div>
          </div>
        </div>
