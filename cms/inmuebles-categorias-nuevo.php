...
if($proceso == "Registrar"){
  ...
  $insertarCategoria = "INSERT INTO inmuebles_categorias(slug, categoria, orden, estado)VALUE('$slug', '$categoria', '$orden', '$estado')";
  $resultadoInsertar = mysqli_query($enlaces,$insertarCategoria);
  $mensaje = "<div class='alert alert-success' role='alert'>
          <button type='button' class='close' data-dismiss='alert' aria-label='Close'><span aria-hidden='true'>&times;</span></button>
          <strong>Nota:</strong> La categor&iacute;a se registr&oacute; con exitosamente. <a href='inmuebles-categorias.php'>Ir a Categorias de Inmuebles</a>
        </div>";
}
?>
<!DOCTYPE html>
  ...
  <head>
    ...
    <script>
      function Validar(){
        ...
        document.fcms.action = "inmuebles-categorias-nuevo.php";
